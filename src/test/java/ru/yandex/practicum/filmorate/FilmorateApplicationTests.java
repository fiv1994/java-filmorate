...
class FilmorateApplicationTests {
	...
	private Film createNewFilm(Integer id, String name, String description, LocalDate releaseDate,
	...
	private User createNewUser(Integer id, String email, String login,
	...
	public void getFilmsList() {
		...
		//when
		List<Film> filmListActual = filmStorage.getAll();
	...
	public void createFilm() {
		...
		//when
		Film filmActual = filmStorage.createFilm(filmExpected);
	...
	public void updateFilm() {
		...
		Film filmOld = createNewFilm(null, "Name1", "Description1",
				LocalDate.of(2020, 11, 11),110, new RatingMPA(1, "G"));
		filmStorage.createFilm(filmOld);
		Film filmExpected = createNewFilm(1, "Name2", "Description2",
				LocalDate.of(2020, 12, 12),120, new RatingMPA(2, "PG"));

		//when
		filmStorage.updateFilm(filmExpected);
		Optional<Film> filmActual = filmStorage.getFilmById(1);
	...
	public void getMostPopularFilms() {
		...
		//when
		List<Film> mostPopularFilmList = filmStorage.getPopularFilms(2);
	...
	public void findFilmById() {
		...
		filmStorage.createFilm(expectedFilm);
	...
	public void getUserList() {
		...
		//when
		List<User> userListActual = userStorage.getAll();
	...
	public void createUser() {
		...
		//when
		User userActual = userStorage.createUser(userExpected);
	...
	public void updateUser() {
		...
		User userOld = createNewUser(null, "ivan1@mail.ru", "ivan1985_1", "Ivan I",
				LocalDate.of(1985, 10, 10));
		userStorage.createUser(userOld);
		User userExpected = createNewUser(1, "ivan2@mail.ru", "ivan1985_2", "Ivan II",
				LocalDate.of(1986, 10, 10));

		//when
		userStorage.updateUser(userExpected);
		User userActual = userStorage.getAll().getFirst();
	...
	public void getFriendsList() {
		...
		//when
		List<User> friendsList = userStorage.getFriendsList(1);
	...
	public void getCommonFriendsList() {
		...
		//when
		List<User> commonFriends = userStorage.getCommonFriendsList(1, 2);
	...
	public void getAllMpa() {
		List<RatingMPA> mpaList = mpaStorage.getAllMpa();
	...
	public void getMpaById() {
		RatingMPA ratingMPA = mpaStorage.getMpaById(2);
